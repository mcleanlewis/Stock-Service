...
//amount of overhead in the RDB by using java to analyse if it requires updataing the stock
...
// the 2 answers, if is is false the variables are changed and true is retruned
